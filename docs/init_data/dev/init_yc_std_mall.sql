...
INSERT INTO `tsys_config` (`type`,`ckey`,`cvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('S','STORE_XFFX','0.2','',now(),' C端消费橙券返现人民币比例','CD-CYC000009','CD-CYC000009');
/*
...
INSERT INTO `tsys_dict` (`type`,`parent_key`,`dkey`,`dvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('1','store_pay_type','50','姚橙020橙券支付','admin',now(),'','CD-CYC000009','CD-CYC000009');
