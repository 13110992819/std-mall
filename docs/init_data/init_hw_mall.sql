...
INSERT INTO `tsys_config` (`type`,`ckey`,`cvalue`,`updater`,`update_datetime`,`remark`,`company_code`,`system_code`) VALUES ('mall','back_oneref_xjk_rate','0.02','',now(),'商城订单人民币支付一级推荐人返现小金库比例','CD-CHW000015','CD-CHW000015');
